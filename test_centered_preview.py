#!/usr/bin/env python3
"""
Test script for the centered page preview
"""
...
from centered_page_preview import apply_zoom_fix
from logging_config import get_logger

logger = get_logger()

class TestCenteredPreviewWindow(QMainWindow):
    """Test window for the centered page preview"""
    
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Centered Page Preview Test")
    ...
    def load_test_content(self):
        ...
        <html>
        <head>
            <title>Centered Page Preview Test</title>
            <meta charset="utf-8">
        </head>
        <body>
            <div class="page">
                <h1>Centered Page Preview Test</h1>
                <p>This is a test document to verify the centered page preview implementation.</p>
...
if __name__ == "__main__":
    ...
    window = TestCenteredPreviewWindow()
    window.show()
    sys.exit(app.exec())